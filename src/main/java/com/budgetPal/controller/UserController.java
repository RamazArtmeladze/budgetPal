...
public class UserController {
    ...
    @PatchMapping("updateUserLastNameByEmail")
    public ResponseEntity<?> updateUserLastNameByEmail (@RequestBody UserRegisterDto userRegisterDto) {

        UserModelDto updatedUser = userService.updateUserLastNameByEmail(userRegisterDto);

        return new ResponseEntity<>(updatedUser,HttpStatus.OK);
    }

    @PatchMapping("updateUserNameByEmail")
    public ResponseEntity<?> updateUserNameByEmail (@RequestBody UserRegisterDto userRegisterDto) {

        UserModelDto updatedUser = userService.updateUserNameByEmail(userRegisterDto);
